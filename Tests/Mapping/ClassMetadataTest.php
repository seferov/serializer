...
class ClassMetadataTest extends \PHPUnit_Framework_TestCase
{
    public function testInterface()
    {
        ...
        $this->assertInstanceOf('Seferov\Component\Serializer\Mapping\ClassMetadataInterface', $classMetadata);
    }
    ...
    public function testAttributeMetadata()
    {
        ...
        $a1 = $this->getMock('Seferov\Component\Serializer\Mapping\AttributeMetadataInterface');
        $a1->method('getName')->willReturn('a1');

        $a2 = $this->getMock('Seferov\Component\Serializer\Mapping\AttributeMetadataInterface');
    ...
    public function testMerge()
    {
        ...
        $ac1 = $this->getMock('Seferov\Component\Serializer\Mapping\AttributeMetadataInterface');
        $ac1->method('getName')->willReturn('a1');
        $ac1->method('getGroups')->willReturn(array('a', 'b'));

        $ac2 = $this->getMock('Seferov\Component\Serializer\Mapping\AttributeMetadataInterface');
